...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="">
                    <a href="{{url('/facilitator/programme')}}">
                        <i class="iconsmind-Building"></i> <span>Add Programme</span>
                        <span class="pull-right-container">
                <i class="fa fa-angle-right pull-right"></i>
              </span>
                    </a>
                ...
                <li class="">
                    <a href="{{url('/facilitator/add_questions')}}">
                        <i class="iconsmind-Add-File"></i> <span>Add Questions</span>
                        <span class="pull-right-container">
                <i class="fa fa-angle-right pull-right"></i>
              </span>
                    </a>
                ...
                <li class="">
                    <a href="{{url('/facilitator/current_questions')}}">
                        <i class="iconsmind-Add-File"></i> <span>Current Questions</span>
                        <span class="pull-right-container">
                <i class="fa fa-angle-right pull-right"></i>
              </span>
                    </a>
    ...
    <footer class="main-footer">
        ...
        &copy; 2019 <a href="">Adrian Kenya</a>. All Rights Reserved.
    </footer>
